...
#define LT_FUNC  LT(LY_FUNC,   KC_ESC) 
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [LY_NORMAL] = LAYOUT( \
    LT_NUMB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    S(KC_9),          S(KC_0),    KC_Y,    KC_U,   KC_I,     KC_O,     KC_P,     KC_MINS, \
    ...
    LT_MOUS,  KC_LGUI, KC_LALT, KC_BSPC, KC_SPC,  LT_CRSR, KC_ENT,           KC_BSPC,    LT_CRSR, KC_ENT, KC_RCTRL, KC_RALT,  KC_RGUI,  LT_FUNC  \
  ),
   ...
   */
  [LY_CURSOR] = LAYOUT( \
    KC_TAB,  _______, _______, KC_END,  _______, KC_TAB,  _______,    _______, _______, KC_PGDN, KC_PGUP,  KC_HOME, KC_PSCR, KC_BSPC, \
   ...
   */
  [LY_MOUSE] = LAYOUT( \
    _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX, _______,    _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R,    XXXXXXX, XXXXXXX, \
    KC_LCTL, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, XXXXXXX, _______,    _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,    XXXXXXX, XXXXXXX, \
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,    _______, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4,    KC_PGUP, _______, \
    XXXXXXX, _______, _______, _______, XXXXXXX, _______, _______,    _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME,    KC_PGDN, KC_END   \
  ),
  ...
  [LY_NUMBER] = LAYOUT( \
    ...
    _______, _______, KC_SPC,  KC_DEL,  _______, _______, _______,    _______,  KC_BSPC, KC_4,    KC_5,    KC_6,    KC_PPLS, KC_PAST, \
  ...
  S(KC_TILD), KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,      KC_7,     KC_8,      KC_9,      KC_0,    KC_MINS, KC_EQL,  KC_BSLS, \
    _______,  _______, _______, _______, _______, _______, _______,   _______,  _______,   _______,   _______, _______, _______, _______, \
    _______,  _______, _______, _______, _______, _______, _______,   _______,  _______,   _______,   _______, _______, _______, _______  \
  )
