...
#define N_____M____COMM__DOT___SLSH   KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH
  ...
  [LY_NRML] = LAYOUT_wrapper(
    ...
    LT_LFN,  KC_LALT,KC_GUI, KC_MHEN, KC_BSPC, LT_SPC, _______, _______, LT_SPC, KC_ENT,  KC_HENK, KC_RALT,_______, LT_RFN 
   ),
...
#define K_____M____COMM__DOT___SLSH   KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH
   ...
   * `-----------------------------------------------------------------------------------'
   */
  [LY_CRSR] = LAYOUT_wrapper(
    KC_ESC,  _______, _______, _______, _______,  _______,                   _______, _______, _______, _______,  KC_HOME,  _______,
    _______, _______, _______, KC_END,  _______,  _______,                   KC_HOME, KC_PGDN, KC_PGUP, _______,  _______,  _______,
    KC_LCTL, KC_HOME, KC_SPC,  KC_DEL,  _______,  _______,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_END,   _______,
    KC_LSFT, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE, KC_BSPC, _______, _______, KC_ENT,  _______, _______, _______,  _______,  _______,
    _______, KC_LALT, KC_GUI,  KC_MHEN, KC_BSPC,  LT_SPC,  _______, _______, LT_SPC,  KC_ENT,  KC_HENK, KC_RALT,  _______,  _______
   ),
...
#define GRV__SLSH KC_GRV,  KC_SLSH
   ...
   * `-----------------------------------------------------------------------------------'
   */
  [LY_NUMB] = LAYOUT_wrapper(
    KC_ESC,  _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, KC_BSLS,
    _______, _______, _______, KC_EQL,  _______, _______,                   _______, KC_0,    KC_5,    KC_6,    _______, _______,
    KC_LCTL, _______, KC_SPC,  KC_DEL,  _______, _______,                   KC_0,    KC_1,    KC_2,    KC_3,    _______, _______,
    KC_LSFT, _______, _______, KC_COMM, _______, _______, _______, _______, KC_BSPC, KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH, _______,
    _______, KC_LALT, KC_GUI,  KC_MHEN, KC_BSPC, KC_SPC,  _______, _______, KC_SPC,  KC_ENT,  KC_HENK, KC_RALT, _______, _______ 
   ),
