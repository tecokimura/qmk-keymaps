...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [LY_CRSR] = LAYOUT(
      JP_ZKHK, _______, _______, _______, _______,  _______,                   KC_CAPS, _______, _______, _______, KC_HOME, KC_GRAVE,
  ...
  [LY_NUMB] = LAYOUT(
      ...
      _______, _______, _______, KC_EQL,  _______, _______,                   _______, KC_4,    KC_5,    KC_6,    _______, _______,
      ...
      _______, KC_LALT, KC_LGUI, KC_MHEN, KC_BSPC, KC_SPC,  _______, _______, KC_SPC,  KC_ENT,  KC_HENK, KC_RALT, _______, JP_EQL 
   ),
