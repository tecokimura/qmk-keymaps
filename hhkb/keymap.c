...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LY_NRML] = LAYOUT_JP(
        LT_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_6,    KC_7,    KC_8,    KC_9,   KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_BSPC,
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_GRAVE,KC_UP,   LT_RFN,
   LT_LFN, KC_ZKHK, KC_LGUI, KC_LALT, KC_BSPC,      LY_CRSR,        KC_ENT,  KC_KANA, KC_RALT, LT_RFN,   KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [LY_CRSR] = LAYOUT_JP(
        ...
        KC_LSFT, _______, _______, _______, _______, KC_BSPC, KC_ENT,  _______, KC_COMM, KC_DOT,  KC_SLSH, _______, KC_UP,   KC_RSFT,
   LT_LFN, KC_ZKHK, KC_LGUI, KC_LALT, KC_BSPC,      LY_CRSR,        KC_ENT,  KC_KANA, KC_RALT, LT_RFN,   KC_LEFT, KC_DOWN, KC_RGHT),

    [LY_NUMB] = LAYOUT_JP(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, KC_EQL,  _______, _______, _______, KC_7,    KC_8,    KC_9,    KC_MINS, _______, _______,
        KC_LCTL, _______, KC_SPC,  KC_DEL,  _______, _______, KC_0,    KC_4,    KC_5,    KC_6,    KC_PLUS, JP_ASTR, _______, _______,
 ...
 _______, _______, _______, _______, _______,       _______,       _______, _______, _______, _______,     KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [LY_RFNC] = LAYOUT_JP(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DOWN, _______, KC_RSFT,
 _______, _______, _______, _______, _______,       _______,       _______, _______, _______, _______,     _______, _______, _______)};
