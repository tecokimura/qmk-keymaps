...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |Fn ||Alt|Cmd|IME|Bsp|  Space  |Ent|IME|Alt|Fn ||Lft|Dwn|Rgh|
     * `-----------------------------------------------------------'
     */
    [LY_NRML] = LAYOUT_jp(
        ...
        LT_LFN,  KC_LALT, KC_LGUI, IMEOFF, KC_BSPC,      LT_SPC,     KC_ENT,   IMEON,  KC_RALT, LT_RFN,  KC_LEFT,  KC_DOWN, KC_RGHT),
     ...
     * |--------------------------------------------------------------|
     * |Shft |   |  |    |   |Mos1|Mos2|Mos3|Mos4|   |   |BrDw|Up|BrUp|
     * |--------------------------------------------------------------|
     * |   |   |   |   |    |   | Clck |   |   |   |  |  |Lft|Dwn|Rght|
     * `--------------------------------------------------------------'
     */
